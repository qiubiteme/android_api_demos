 ...
 // BEGIN_INCLUDE(calling_a_service)
    public static class Binding extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mCallbackText.setText("不附。Not attached.");
        }
        ...
        private ServiceConnection mConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className,
                ...
                mCallbackText.setText("附。Attached.");
            ...
            public void onServiceDisconnected(ComponentName className) {
                ...
                mService = null;
                mKillButton.setEnabled(false);
                mCallbackText.setText("断开的Disconnected.");
        ...
        private OnClickListener mBindListener = new OnClickListener() {
            public void onClick(View v) {
                ...
                mIsBound = true;
                mCallbackText.setText("绑定Binding.");
            }
        };
        ...
        private OnClickListener mUnbindListener = new OnClickListener() {
            public void onClick(View v) {
                if (mIsBound) {
                    ...
                    mKillButton.setEnabled(false);
                    mIsBound = false;
                    mCallbackText.setText("解除绑定Unbinding.");
                }
            }
        };
            ...
            public void onClick(View v) {
                ...
                if (mSecondaryService != null) {
                    try {
                        ...
                        mCallbackText.setText("杀了服务进程。Killed service process.");
        ...
        private Handler mHandler = new Handler() {
            @Override public void handleMessage(Message msg) {
                switch (msg.what) {
                    case BUMP_MSG:
                        mCallbackText.setText("从收到的服务：Received from service: " + msg.arg1);
                        break;
                    default:
                        super.handleMessage(msg);
                }
    ...
    public static class BindingOptions extends Activity {
        ...
        class MyServiceConnection implements ServiceConnection {
            ...
            public void onServiceConnected(ComponentName className,
                ...
                mCallbackText.setText("附Attached.");
            ...
            public void onServiceDisconnected(ComponentName className) {
                ...
                mCallbackText.setText("断开Disconnected.");
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mCallbackText = (TextView)findViewById(R.id.callback);
            mCallbackText.setText("不附Not attached.");
