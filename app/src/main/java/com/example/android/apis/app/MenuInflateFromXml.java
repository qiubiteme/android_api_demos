...
public class MenuInflateFromXml extends Activity {
    ...
    private static final String sMenuExampleNames[] = {
            "只有标题Title only", "标题和图标Title and Icon", "子Submenu", "组Groups",
            "可勾选Checkable禁用", "快捷方式Shortcuts", "订单Order", "分类与秩序Category and Order",
            "可见Visible", "禁用Disabled"
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            //                   the XML
            case R.id.jump:
                Toast.makeText(this, "跳起来在空中！Jump up in the air!", Toast.LENGTH_SHORT).show();
                invalidateOptionsMenu();
                return true;

            case R.id.dive:
                Toast.makeText(this, "潜入水中！Dive into the water!", Toast.LENGTH_SHORT).show();
                return true;
