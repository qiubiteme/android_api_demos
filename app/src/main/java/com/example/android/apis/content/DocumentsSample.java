...
public class DocumentsSample extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        multiple.setText("允许多个ALLOW_MULTIPLE");
        view.addView(multiple);
        final CheckBox localOnly = new CheckBox(context);
        localOnly.setText("只有本地LOCAL_ONLY");
        view.addView(localOnly);

        Button button;
        button = new Button(context);
        button.setText("开放文档OPEN_DOC */*");
        ...
        button = new Button(context);
        button.setText("开放文档图片 OPEN_DOC image/*");
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_OPEN_DOCUMENT);
        ...
        button = new Button(context);
        button.setText("开放文档音频OPEN_DOC audio/ogg");
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_OPEN_DOCUMENT);
        ...
        button = new Button(context);
        button.setText("纯文本，word文档OPEN_DOC text/plain, application/msword");
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_OPEN_DOCUMENT);
                ...
                intent.putExtra(Intent.EXTRA_MIME_TYPES, new String[] {
                        "简单的应用文档text/plain", "application/msword" });
                if (multiple.isChecked()) {
                    intent.putExtra(Intent.EXTRA_ALLOW_MULTIPLE, true);
                }
                if (localOnly.isChecked()) {
        ...
        button = new Button(context);
        button.setText("创建doc纯文本CREATE_DOC text/plain");
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        button = new Button(context);
        button.setText("创建_ DOC图像CREATE_DOC image/png");
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_CREATE_DOCUMENT);
        ...
        button = new Button(context);
        button.setText("获取内容GET_CONTENT */*");
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
