...
public class Kube extends Activity implements KubeRenderer.AnimationCallback {
    ...
    private GLWorld makeGLWorld() {
        ...
        // 坐标为我们的数据集coordinates for our cubes
        float c0 = -1.0f;
        float c1 = -0.38f;
        float c2 = -0.32f;
        float c3 = 0.32f;
        ...
        // 上,从左到右top middle, left to right
        ...
        //上,从左到右 top front, left to right
        ...
        // 中间,从左到右middle back, left to right
        ...
        //下,从左到右 bottom back, left to right
        ...
        //底部的中间,从左到右 bottom middle, left to right
        ...
        //下,从左到右 bottom front, left to right
        ...
        //油漆双方 paint the sides
        int i, j;
        //默认设置所有的脸黑set all faces black by default
        for (i = 0; i < 27; i++) {
            Cube cube = mCubes[i];
            if (cube != null) {
                for (j = 0; j < 6; j++)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 我们不需要一个标题。We don't need a title either.
