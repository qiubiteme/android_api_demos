...
//END_INCLUDE(intent_array)
    ...
    void showAppNotification() {
        ...
        CharSequence from = "乔Joe";
        CharSequence message;
        switch ((new Random().nextInt()) % 3) {
            case 0: message = "饿了吗？我是饥饿r u hungry?  i am starved"; break;
            case 1: message = "我是附近的U im nearby u"; break;
            default: message = "见面吃饭。 再见kthx. meet u for dinner. cul8r"; break;
        }
...
//BEGIN_INCLUDE(interstitial_notification)
    ...
    void showInterstitialNotification() {
        ...
        CharSequence message;
        switch ((new Random().nextInt()) % 3) {
            case 0: message = "我准备吃晚饭i am ready for some dinner"; break;
            case 1: message = "如何泰下来块？how about thai down the block?"; break;
            default: message = "很快满足ü。不要迟到！meet u soon. dont b late!"; break;
        }
