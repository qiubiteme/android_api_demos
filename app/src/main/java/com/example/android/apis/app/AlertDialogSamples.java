            ...
            return new AlertDialog.Builder(AlertDialogSamples.this)
                ...
                .setPositiveButton(R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        /* 用户点击是的一些东西User clicked Yes so do some stuff */
                    }
                })
                .setNegativeButton(R.string.alert_dialog_cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        new DialogInterface.OnMultiChoiceClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton,
                                ...
                                Toast.makeText(AlertDialogSamples.this,
                                        "只读演示只 - 数据将不会被更新Readonly Demo Only - Data will not be updated",
                                        Toast.LENGTH_SHORT).show();
                            }
                        })
               .create();
        case DIALOG_TEXT_ENTRY:
 /*            这个例子展示了如何添加一个自定义布局一个警告对话框;This example shows how to add a custom layout to an AlertDialog*/
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        /* 显示的项目列表Display a list of items */
        ...
        /* 自定义进度条显示Display a custom progress bar */
