...
public class SystemUIModes extends Activity
    ...
    public static class IV extends ImageView implements View.OnSystemUiVisibilityChangeListener {
        ...
        private class MyActionModeCallback implements ActionMode.Callback {
            @Override public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                mode.setTitle("我的操作模式！My Action Mode!");
                mode.setSubtitle(null);
                mode.setTitleOptionalHint(false);
                menu.add("按大小排序Sort By Size").setIcon(android.R.drawable.ic_menu_sort_by_size);
                menu.add("排序方式阿尔法Sort By Alpha").setIcon(android.R.drawable.ic_menu_sort_alphabetically);
                return true;
            }
    ...
    private String getDisplaySize() {
        ...
        return String.format("显示度量DisplayMetrics = (%d x %d)", dm.widthPixels, dm.heightPixels);
    }
