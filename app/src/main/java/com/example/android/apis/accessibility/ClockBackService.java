...
public class ClockBackService extends AccessibilityService {
    ...
    /**
     * Tag for logging from this service.标签从该服务登录
     */
    private static final String LOG_TAG = "ClockBackService";

    // Fields for configuring how the system handles this accessibility service.字段配置系统如何处理这种辅助服务。
     ...
     *      * </ P>
     */
    // This works with AlarmClock and Clock whose package name changes in different releases这适用的AlarmClock和时钟的包不同版本名称变更
...
//    消息类型，我们身边掠过。
    ...
    private String generateScreenOnOrOffUtternace(int feedbackIndex) {
        // Get the announce template.获取宣布模板。
