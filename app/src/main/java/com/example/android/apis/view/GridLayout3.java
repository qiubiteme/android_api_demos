...
public class GridLayout3 extends Activity {
    public static View create(Context context) {
...

        {
            ...
            c.setTextSize(32);
            c.setText("电子邮件设置Email setup");
            p.addView(c, new LayoutParams(titleRow, centerInAllColumns));
        }
        {
            TextView c = new TextView(context);
            c.setTextSize(16);
            c.setText("您可以在几个简单的步骤设置电子邮件：You can configure email in a few simple steps:");
            p.addView(c, new LayoutParams(introRow, leftAlignInAllColumns));
        }
        {
            TextView c = new TextView(context);
            c.setText("电子邮件地址Email address:");
