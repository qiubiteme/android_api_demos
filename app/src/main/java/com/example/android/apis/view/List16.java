...
public class List16 extends ListActivity {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setSubtitle("长按开始选择Long press to start selection");
    }
    ...
    private class ModeCallback implements ListView.MultiChoiceModeListener {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            mode.setTitle("选择项目Select Items");
            return true;
        }
        ...
        public void onItemCheckedStateChanged(ActionMode mode,
            ...
            switch (checkedCount) {
                case 0:
                    ...
                    break;
                case 1:
                    mode.setSubtitle("一个项目选择One item selected");
                    break;
                default:
                    mode.setSubtitle("" + checkedCount + " 所选项目items selected");
                    break;
            }
        }
